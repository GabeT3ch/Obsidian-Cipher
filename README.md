...
## Project Structure
Here are both files to paste directly:
...
Get your key from console.anthropic.com. A $5 credit is more than enough — each encrypt call costs a fraction of a cent.
3. Launch
...
Encrypt
    ...
    Type your message in Plaintext Message
    Enter a Secret Key (any string)
    Click ⚡ Encrypt
...
Decrypt
    ...
    Paste the hex ciphertext (auto-filled if you just encrypted)
